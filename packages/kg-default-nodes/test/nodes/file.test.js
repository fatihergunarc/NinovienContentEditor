...
describe('FileNode', function () {
    ...
    describe('exportDOM', function () {
        it('creates a file card', editorTest(function () {
            ...
            element.outerHTML.should.equal(`<div class="kg-card kg-file-card"><a class="kg-file-card-container" href="/content/files/2023/03/IMG_0196.jpeg" title="Open file" target="_blank" rel="noopener noreferrer"><div><div class="flex justify-between rounded-md border border-grey/30 p-2"><div class="flex w-full flex-col px-2 font-sans justify-between"><div class="flex flex-col"><div class="h-[30px] bg-transparent text-lg font-bold leading-none tracking-tight text-black dark:text-grey-200" data-kg-file-card="fileTitle">Cool image to download</div><div class="h-[26px] bg-transparent pb-1 text-[1.6rem] font-normal leading-none text-grey-700 dark:text-grey-300" data-kg-file-card="fileDescription">This is a description</div></div><div class="!mt-0 py-1 text-sm font-medium text-grey-900 dark:text-grey-200" data-kg-file-card="dataset">IMG_0196.jpeg<span class="text-grey-700"> • 121 KB</span></div></div><div class="!mt-0 flex w-full max-w-[96px] items-center justify-center rounded-md bg-grey-200 dark:bg-grey-900 h-[96px]"><svg viewBox="0 0 24 24" class="text-green transition-all duration-75 ease-in size-6" xmlns="http://www.w3.org/2000/svg"><defs><style>.a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px}</style></defs><path class="a" d="M8.25 14.25 12 18l3.75-3.75M12 6.75V18"></path><circle class="a" cx="12" cy="12" r="11.25"></circle></svg></div></div></div></a></div>`);
